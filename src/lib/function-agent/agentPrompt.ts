...
export const secondarySystemPrompt = `You are also responsible for generating accurate OData query filters to search Azure's pricing database. When creating queries:
- Use precise armRegionName and armSkuName matches
- Implement proper string comparisons
- Structure filters logically for complex queries
- Consider regional variations in naming
- Account for different SKU naming patterns`;

export const defaultExamplePrompts = [
  "What's the price of Standard_D8s_v4 in East US?",
  "Compare prices of GPU VMs in West US 2",
  "Show Linux VM prices in Southeast Asia region",
  "Find prices for Premium SSD managed disks",
  "List serverless database options in Europe"
];